...
If your application become bigger : 

* use gtk directly by Ruiby extensions: write your gtk code, call it by define a new Ruiby DSL word, add to plugin directory
...
Doc: [Ref.](https://rawgithub.com/raubarede/Ruiby/master/doc.html)   
     ...
     generated by samples/make_doc.rb, with lexical, doc ref, codes exemples,....
...
NEW : 0.121.0 !!  30-08-2013
- EventMachine integration (main loop by EM.run if EM is present)
- paned : no more array
- contaners left and right for align widget (todo: top/bottom ?)
...
*  window resize scratch on windows, sometime...
...
Usage with gtk2 : preloag gtk2 before Ruiby :
...
See end of Doc referenc: [Ref](https://rawgithub.com/raubarede/Ruiby/master/doc.html) 
